export const DISTRICTS = [
  ...
  // 대구광역시
  '대구시 군위군', '대구시 남구', '대구시 달서구', '대구시 달성군', '대구시 동구',
  '대구시 북구', '대구시 서구', '대구시 수성구', '대구시 중구',

  // 인천광역시
  '인천시 강화군', '인천시 계양구', '인천시 남동구', '인천시 동구', '인천시 미추홀구',
  '인천시 부평구', '인천시 서구', '인천시 연수구', '인천시 옹진군', '인천시 중구',
  ...
  // 울산광역시
  '울산시 남구', '울산시 동구', '울산시 북구', '울산시 울주군', '울산시 중구',
  ...
  // 강원특별자치도
  '강원도 강릉시', '강원도 고성군', '강원도 동해시', '강원도 삼척시', '강원도 속초시',
  '강원도 양구군', '강원도 양양군', '강원도 영월군', '강원도 원주시', '강원도 인제군',
  ...
  '전라북도 장수군', '전라북도 전주시 덕진구', '전라북도 전주시 완산구', '전라북도 정읍시',
  '전라북도 진안군',
  ...
  '경상북도 칠곡군', '경상북도 포항시 남구', '경상북도 포항시 북구',
